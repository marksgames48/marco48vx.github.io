...
var items = [
	...
	{name:'CS:GO Weapon Case 2', price:5.00, class:'standard', case:'csgo_weapon2', type:'case', needkey:true, rankNeeded:1},
	{name:'Stattrak Case', price:2.00, class:'standard', case:'stattrak', type:'case', needkey:false, rankNeeded:1},
	{name:'Shadow Case', price:3.50, class:'standard', case:'shadow', type:'case', needkey:true, rankNeeded:1},
	{name:'Falchion Case', price:1.75, class:'standard', case:'falchion', type:'case', needkey:true, rankNeeded:1},
	{name:'The Gods and Monsters Collection', price:35.00, class:'standard', case:'gods_and_monsters', type:'case', needkey:false, rankNeeded:1},
	{name:'CS:GO Weapon Case 3', price:2.30, class:'standard', case:'csgo_weapon3', type:'case', needkey:true, rankNeeded:1},
	{name:'Operation Vanguard Weapon Case', price:10.00, class:'standard', case:'vanguard', type:'case', needkey:true, rankNeeded:1},
	{name:'The Cobblestone Collection', price:40.00, class:'standard', case:'cobblestone', type:'case', needkey:false, rankNeeded:1},
	{name:'Stattrak Case 2', price:3.50, class:'standard', case:'stattrak2', type:'case', needkey:false, rankNeeded:1},
	{name:'Chroma Case 2', price:1.50, class:'standard', case:'chroma2', type:'case', needkey:true, rankNeeded:1},
	{name:'Operation Hydra Case', price:8.00, class:'standard', case:'hydra', type:'case', needkey:true, rankNeeded:1},
	{name:'Revolver Case', price:2.60, class:'standard', case:'revolver', type:'case', needkey:true, rankNeeded:1},
	{name:'Gamma Case 2', price:1.50, class:'standard', case:'gamma2', type:'case', needkey:true, rankNeeded:1},
	{name:'Stattrak Case 3', price:10.00, class:'standard', case:'stattrak3', type:'case', needkey:false, rankNeeded:1},
	{name:'Knife Case', price:1000.00, class:'standard', case:'knife', type:'case', needkey:false, rankNeeded:1},
	{name:'Chroma Case 3', price:1.50, class:'standard', case:'chroma3', type:'case', needkey:true, rankNeeded:1},
	{name:'The Chop Shop Collection', price:18.00, class:'standard', case:'chopshop', type:'case', needkey:false, rankNeeded:1},
	{name:'Stattrak Case 4', price:200.00, class:'standard', case:'stattrak4', type:'case', needkey:false, rankNeeded:1},
	{name:'The Rising Sun Collection', price:7.50, class:'standard', case:'risingsun', type:'case', needkey:true, rankNeeded:1},
